...
export class RealtimeClient extends RealtimeEventHandler {
   ...
   * @param {{url?: string, apiKey?: string, dangerouslyAllowAPIKeyInBrowser?: boolean, debug?: boolean, voice?: string, instructions?: string}} [settings]
   */
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug, voice = 'verse', instructions = '' } = {}) {
    super();
    this.defaultSessionConfig = {
      ...
      // should controlled by fe, just add to test
      ...
      turn_detection: {
        ...
        silence_duration_ms: 900, // How long to wait to mark the speech as stopped.
      },
      tools: [],
      tool_choice: 'auto',
      temperature: 0.8,
